...
export const factsUi: Record<string, L12> = {
  ...
  placesH2: {
    ...
    de: 'Wohin die Einheimischen schicken.', fr: 'Où les habitants vous envoient.', es: 'Adonde le mandan los de aquí.',
  ...
  placesNote: {
    ...
    es: 'Negocios locales independientes, incluidos porque están abiertos y merecen la caminata. Son enlaces normales, no ubicaciones pagadas, y no ganamos nada si usted va.',
  ...
  stats: [
    ...
    },
    {
      ...
      label: {
        ...
        de: 'Dörfer, ein Fjell', fr: 'villages, un fjäll', es: 'pueblos, una montaña',
        it: 'villaggi, una montagna', nl: 'dorpen, één fjäll', 'pt-BR': 'vilarejos, uma montanha',
  ...
  highlights: [
    {
      ...
      body: {
        ...
        fr: '62 pistes sur les deux versants du fjäll et les plus longues descentes de Finlande : plus de trois kilomètres du sommet dénudé jusqu’à la vallée, 464 mètres de dénivelé. Des navettes ski relient les deux villages aux remontées.',
        ...
        nl: '62 pistes op twee zijden van de fjäll en de langste afdalingen van Finland: ruim drie kilometer van de kale top tot in het dal, 464 meter hoogteverschil. Skibussen verbinden beide dorpen met de liften.',
    ...
    },
    {
      ...
      body: {
        ...
        es: 'Unos 300 kilómetros de pistas mantenidas recorren los bosques del parque nacional, más de 30 iluminados para los meses oscuros. Elija un café de pista como destino y esquíe hasta allí a tomar un café.',
  ...
  highlights: [
    {
      ...
      body: {
        ...
        es: 'El círculo polar cruza Rovaniemi a 66°33′ de latitud norte. Del 6 de junio al 7 de julio el sol no se pone. En diciembre sigue saliendo: el 21 de diciembre, de 11:08 a 13:22, algo más de dos horas de luz. La noche polar de verdad, kaamos en finlandés, empieza más al norte.',
  ...
  highlights: [
    {
      ...
      body: {
        ...
        sv: '44 backar faller från Levitunturi ner till byn vid foten, och två gondoler tar dig till toppen på 531 meter. Alpina världscupens slalomsäsong inleds här varje november, och säsongens första slalom åks i frontbacken den 14 och 15 november 2026.',
        ...
        es: '44 pistas descienden del Levitunturi hasta el pueblo a sus pies, y dos telecabinas le llevan a la cima de 531 metros. La Copa del Mundo de esquí alpino se inaugura aquí cada noviembre, y el primer eslalon de la temporada se disputa en la pista frontal el 14 y 15 de noviembre de 2026.',
    ...
    },
    {
      ...
      body: {
        ...
        es: 'Unos 230 kilómetros de pistas mantenidas salen del pueblo hacia los fjells, y 28 kilómetros están iluminados durante los meses oscuros. Elija un café de pista como punto de retorno, esquíe hasta allí a tomar un café y regrese deslizándose antes del anochecer.',
        fr: 'Environ 230 kilomètres de pistes entretenues partent du village vers les fjälls, dont 28 kilomètres éclairés pendant les mois sombres. Choisissez un café de piste comme point de demi-tour, rejoignez-le à ski pour un café et revenez en glissant avant la nuit.',
    ...
    },
    {
      ...
      body: {
        ...
        sv: 'Liftar, restauranger, butiker och afterskin ligger alla inom några kvarter från varandra. När liftarna stänger flyttar folkmassan till Hullu Poro, ortens långlivade restaurang och livemusikscen.',
  ...
  highlights: [
    {
      ...
      body: {
        ...
        fr: 'C’est ainsi que la station se décrit elle-même. 24 pistes se répartissent sur les fjälls Kaunispää et Iisakkipää, dont 16 éclairées, desservies par six remontées. L’objectif annoncé pour la saison à venir est d’ouvrir le 21 novembre 2026 et de fermer le 2 mai 2027.',
        ...
        nl: 'Zo omschrijft het gebied zichzelf. 24 pistes verdelen zich over de fjälls Kaunispää en Iisakkipää, 16 daarvan verlicht, bediend door zes liften. Het uitgesproken doel voor het komende seizoen is openen op 21 november 2026 en doorgaan tot 2 mei 2027.',
    ...
    },
    {
      ...
      body: {
        ...
        es: 'Kiilopää, gestionado por la asociación de aire libre Suomen Latu, está justo al lado del Parque Nacional Urho Kekkonen. Las rutas señalizadas arrancan en la puerta y van de un circuito de un kilómetro a caminatas de más de veinte, así que la duración del día la elige usted.',
    ...
    },
    {
      ...
      body: {
        ...
        es: 'En Kuurakaltio, Kiilopää calienta un sauna de humo tradicional junto a un arroyo de montaña, y el refresco se toma en el agua corriente en lugar de en una piscina. Los turnos de sauna públicos están abiertos también a quienes no se alojan allí.',
        fr: 'À Kuurakaltio, Kiilopää chauffe un sauna à fumée traditionnel au bord d’un ruisseau de fjäll, et l’on se rafraîchit dans l’eau courante plutôt que dans un bassin. Les créneaux de sauna publics sont ouverts aussi à ceux qui ne logent pas sur place.',
  ...
  highlights: [
    ...
    },
    {
      ...
      body: {
        ...
        es: 'El sami septentrional, el sami de Inari y el sami skolt están aquí en uso oficial junto al finlandés, y casi un tercio de los habitantes del municipio son sami. Siida, el museo nacional de la cultura sami, sitúa su exposición principal y su museo al aire libre frente a la naturaleza del extremo norte.',
    ...
    },
    {
      ...
      body: {
        ...
        fr: 'Inari couvre cinq pour cent de la superficie de la Finlande, et deux tiers de ses habitants vivent à Ivalo plutôt qu’au village d’Inari même. Ce qui reste autour du village, c’est de l’espace : forêt, eau et fjäll ouvert, avec très peu de choses entre les deux.',
