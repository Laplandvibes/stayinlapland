...
const picks: PartnerSnapshot = {
  "_comment": "GENEROITU — älä muokkaa käsin. node scripts/sync_partner_feeds.mjs finlayson --refresh",
  "advertiser": "Finlayson",
  "programme": {
    "network": "adtraction",
    "programId": 1712983670,
    "commission": "7.7%",
    "cookieDays": 30
  },
  "route": "/go/finlayson",
  ...
  "products": [
    ...
    },
    {
      ...
      "shelf": "palttina-aluslakanat",
      "category": "Palttina-aluslakanat",
      "brand": "Finlayson FI",
      "price": 29.95,
      "currency": "EUR",
      "url": "https://www.finlayson.fi/products/yksivarinen-aluslakana-3",
