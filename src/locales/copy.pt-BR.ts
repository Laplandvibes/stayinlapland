...
export const copyPTBR: SectionCopy = {
  ...
  destinationsData: [
    ...
    },
    {
      slug: 'levi',
      pitch:
        'A maior estação de esqui da Finlândia, com a maior oferta de apartamentos pé na pista e uma rua de vila de verdade.',
      longStayAngle:
    ...
    {
      slug: 'inari',
      pitch: 'Capital cultural sami, lago Inari (1 084 km²), a base de estadia longa mais ao norte da Finlândia.',
      longStayAngle:
