...
const CAT_I18N: Record<Cat, Record<string, string>> = {
  hub:       { en: 'Network hub', fi: 'Verkoston keskus', de: 'Netzwerk-Zentrale', ja: 'ネットワークの拠点', es: 'Centro de la red', 'pt-BR': 'Central da rede', 'zh-CN': '站群中心', ko: '네트워크 허브', fr: 'Centre du réseau', it: 'Centro della rete', nl: 'Netwerkcentrum', sv: 'Nätverkets nav' },
