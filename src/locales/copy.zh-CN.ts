...
export const copyZHCN: SectionCopy = {
  ...
  newsletter: {
    eyebrow: '长期入住开放 · 淡季价格',
    h2: '您尚未能预订的住宿。',
    lead: '本网站大部分长期入住物业在 8 月底释放冬季库存,并在四周内售罄。订阅者将提前获得通知, 还有淡季周(11 月、4 月下旬),此时每晚价格下降 50%,极光依然活跃。',
    placeholder: '您的邮箱地址',
    subscribe: '订阅',
    subscribing: '订阅中…',
  ...
  home: {
    ...
    intro: {
      ...
      p2:
        '我们把拉普兰的住宿分成四个清晰的类别，，长期入住、酒店、玻璃冰屋与荒野别墅。17 处精选,全部亲身体验。最受欢迎的路线是:在莱维住一周木屋,加上罗瓦涅米两晚设计酒店,再以一晚玻璃冰屋收尾。把这些组合在一起,就构成了人们一再回到拉普兰的那种感觉。',
    ...
    faqs: [
      {
        q: '本站所说的"长期入住"指什么?',
        a: '本站把四晚及以上都归为长期入住，，这是拉普兰多数住处开始提供周价、像样厨房真正派上用场的门槛。所列长期入住物业根据房型,最少 5 晚至 4 周不等;每张房卡都会显示最低天数。',
      },
      {
    ...
    categoryDescriptions: {
      ...
      wilderness: '最后一条公路之后，，给认真旅人的三处隐居地。',
    },
    categoryNames: {
      longStays: '长期入住',
      hotels: '酒店',
  ...
  hotels: {
    ...
    introP1:
      '拉普兰不乏把基本功做好的中端连锁酒店，，Scandic、Cumulus、Sokos，，每晚 90–140 €。它们没有列在这里;预订它们的逻辑基本只是"离机场最近、那一周最便宜"。',
    introP2:
  ...
  glassIgloos: {
    ...
    pageHero: {
      ...
      title: '芬兰拉普兰的玻璃冰屋。',
      subtitle:
        '玻璃屋顶的芬兰穹顶 1973 年诞生于萨利色尔卡。如今对得起这个名字的有四家，，而它们彼此之间存在实打实的差别。',
    },
    authorNote: '四家度假村均与运营方公布的资料及近期住客评价交叉核实。价格最近核对时间：2026 年 2 月。',
    pickWhy: [
      'Kakslauttanen 出现在每份清单上,是因为它配得上。这家度假村 1973 年发明了现代玻璃冰屋，，彼时"萨利色尔卡的旅游住宿"还只是一间木屋旅舍,极光则是从停车场抬头看的东西。',
    ...
    pullQuote: {
      text:
        '第一座玻璃冰屋的建造,是为了让客人不必在零下 30 度站到屋外就能看见极光。五十年后,这仍是它的全部卖点，，而每个模仿者都做砸的那一部分,是极光散去之后会发生什么。',
      attr: 'Kakslauttanen 起源 · 1973',
    },
    runnersKicker: '另外三家',
  ...
  longStays: {
    ...
    marginLabel: '预订策略',
    marginBody:
      '住满四周时,把它拆到两处房源,往往能胜过订一处，，既避开圣诞与狂欢节那一记"旺季周"涨价,又能真正看到拉普兰的两个面。转场要花半天,但省下的钱通常够在别处多住两晚。',
    counterKicker: '诚实的反向建议',
    counterH2: '什么时候别订长住。',
    counterP1:
  ...
  bookingGuide: {
    ...
    sections: [
      ...
      },
      {
        title: '怎么抵达',
        body: [
          '三座拉普兰机场覆盖了您会预订的大部分目的地。罗瓦涅米(RVN)通往圣诞老人村和南部,基蒂莱(KTT)通往莱维和于莱斯,伊瓦洛(IVL)通往萨利色尔卡、伊纳里与北部。',
          '赫尔辛基(HEL)→ 拉普兰是 90 分钟的国内航班。十二月至三月也有从伦敦、柏林、巴黎出发的直飞航班。',
          '火车:赫尔辛基，罗瓦涅米的过夜卧铺很慢,但托尔尼奥的破晓确实美,车厢里满是做同一段旅程的本地人。',
        ],
      },
      {
        title: '带什么',
  ...
  whenToGo: {
    ...
    months: [
      ...
      },
      {
        ...
        pitch: '极夜开始,积雪稳定',
        body:
          '拉普兰冬天最冷的起点。极夜在月中自索丹屈莱以北开始。积雪从十一月底开始留得住，，到月末多数度假村和雪旅馆开门。十一月底是长住绝对的性价比之最。',
      ...
      },
      {
        ...
        pitch: '春雪与光',
        body:
          '雪仍深,山坡上的滑雪一流。极光季在四月中、夜色转亮时结束。四月下旬又是过渡季，，房价降 30%,房源仍开门,太阳在地平线以上停留 16 小时以上。',
        bestFor: ['季末滑雪长住', '越野滑雪'],
        avoidIf: ['极光优先的行程'],
      },
    ],
    ...
    cheatH2: '当地人留给自己的三周。',
    cheatP1:
      '<strong class="text-charcoal">十一月底(第 47–48 周)。</strong>积雪刚稳定,极夜达顶峰,极光季全面活跃。长住房价较旺季减 40–50%。部分房源尚未完全开放，，订前确认。',
    cheatP2:
  ...
  destinationPage: {
    ...
    notFoundBody: '我们目前覆盖罗瓦涅米、莱维、萨利色尔卡、伊纳里和于莱斯。',
    backHome: '返回首页',
  ...
  glassIgloosData: [
    {
      ...
      location: '萨利色尔卡',
      highlight: '元祖玻璃冰屋 · 1973 · 提供 Kelo-Glass',
      description:
        '1973 年发明现代玻璃冰屋的度假村。要选 Kelo-Glass,而非经典玻璃冰屋，，Kelo 把全景玻璃屋顶与带暖气的木屋结构、小厨房和壁炉结合在一起。住满两晚才最划算。',
    },
    {
      name: 'Levin Iglut',
      location: '莱维山',
  ...
  destinationsData: [
    ...
    },
    {
      slug: 'levi',
      pitch:
        '芬兰最大的滑雪度假村,滑雪进出公寓的选择最深,还有一条真正的村庄主街。',
      longStayAngle:
    ...
    {
      slug: 'inari',
      pitch: '萨米文化之都,伊纳里湖(1 084 km²),芬兰最北的长住大本营。',
      longStayAngle:
    ...
    },
    {
      slug: 'yllas',
      pitch:
        '比莱维更安静,雪季更长,拥有拉普兰最大的越野滑道网络(330 km)。',
      longStayAngle:
  ...
  allCategoriesSummary: [
    ...
    { slug: 'wilderness', description: '最后一条公路之后，，给认真旅人的三处隐居地。' },
  ],
};
