...
export default function LomarengasAd({
  ...
  const headline = pick({
    ...
    es: '¿Quieren una cabaña entera para ustedes toda la semana? Lomarengas alquila cabañas finlandesas de propietarios particulares.',
  ...
  const sub = pick({
    ...
    es: 'Lomarengas es el hogar de las cabañas finlandesas desde 1967: más de 4400 cabañas seleccionadas a mano, con cada propietario verificado y cada alojamiento revisado en persona. La cabaña junto al lago o la montaña, con su propio sauna, que las grandes webs de hoteles no incluyen.',
