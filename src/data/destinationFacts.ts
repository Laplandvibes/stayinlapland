  ...
  highlights: [
    {
      ...
      body: {
        en: 'The Arctic Circle crosses Rovaniemi at 66°33′ north. From 6 June to 7 July the sun never sets, and from 6 December to 7 January it stays below the horizon: the blue half-light Finns call kaamos.',
        fi: 'Napapiiri kulkee Rovaniemen halki 66°33′ pohjoista leveyttä. Kesäkuun 6. päivästä heinäkuun 7. päivään aurinko ei laske, ja joulukuun 6. päivästä tammikuun 7. päivään se pysyy horisontin alapuolella: sinisenä hämäränä jatkuva kaamos.',
        sv: 'Polcirkeln går genom Rovaniemi vid 66°33′ nordlig bredd. Från 6 juni till 7 juli går solen aldrig ner, och från 6 december till 7 januari stannar den under horisonten: det blå halvdunkel som på finska kallas kaamos.',
        de: 'Der Polarkreis verläuft bei 66°33′ nördlicher Breite durch Rovaniemi. Vom 6. Juni bis 7. Juli geht die Sonne nicht unter, und vom 6. Dezember bis 7. Januar bleibt sie unter dem Horizont: jenes blaue Zwielicht, das auf Finnisch kaamos heißt.',
        es: 'El círculo polar cruza Rovaniemi a 66°33′ de latitud norte. Del 6 de junio al 7 de julio el sol no se pone, y del 6 de diciembre al 7 de enero permanece bajo el horizonte: la penumbra azul que en finés se llama kaamos.',
        fr: 'Le cercle polaire traverse Rovaniemi à 66°33′ de latitude nord. Du 6 juin au 7 juillet, le soleil ne se couche pas, et du 6 décembre au 7 janvier il reste sous l’horizon : cette pénombre bleue que les Finlandais appellent kaamos.',
        it: 'Il circolo polare attraversa Rovaniemi a 66°33′ di latitudine nord. Dal 6 giugno al 7 luglio il sole non tramonta, e dal 6 dicembre al 7 gennaio resta sotto l’orizzonte: quella penombra azzurra che in finlandese si chiama kaamos.',
        nl: 'De poolcirkel loopt bij 66°33′ noorderbreedte door Rovaniemi. Van 6 juni tot 7 juli gaat de zon niet onder, en van 6 december tot 7 januari blijft ze onder de horizon: het blauwe halfduister dat in het Fins kaamos heet.',
        ja: '北極圏は北緯66度33分で Rovaniemi を横切ります。6月6日から7月7日まで太陽は沈まず、12月6日から1月7日までは地平線の下にとどまります。フィンランド語で kaamos と呼ばれる、青い薄明かりの季節です。',
        ko: '북극권은 북위 66도 33분에서 Rovaniemi를 가로지릅니다. 6월 6일부터 7월 7일까지 해가 지지 않고, 12월 6일부터 1월 7일까지는 지평선 아래에 머뭅니다. 핀란드어로 kaamos라 부르는 푸른 어스름의 계절입니다.',
        'zh-CN': '北极圈在北纬 66°33′ 穿过 Rovaniemi。6 月 6 日到 7 月 7 日太阳不落，12 月 6 日到 1 月 7 日则始终停在地平线以下，那是芬兰语称作 kaamos 的蓝色微光季节。',
        'pt-BR': 'O círculo polar cruza Rovaniemi a 66°33′ de latitude norte. De 6 de junho a 7 de julho o sol não se põe, e de 6 de dezembro a 7 de janeiro ele fica abaixo do horizonte: a penumbra azul que em finlandês se chama kaamos.',
      },
    },
    {
      title: {
  ...
  highlights: [
    {
      ...
      body: {
        ...
        de: '44 Pisten fallen vom Levitunturi zum Dorf an seinem Fuß ab, und zwei Gondeln bringen dich auf den 531 Meter hohen Gipfel. Der alpine Weltcup wird hier jeden November eröffnet, und der erste Slalom der Saison wird am 14. und 15. November 2026 an der Frontpiste gefahren.',
        ...
        it: '44 piste scendono dal Levitunturi fino al villaggio ai suoi piedi, e due cabinovie ti portano alla vetta di 531 metri. La Coppa del Mondo di sci alpino si apre qui ogni novembre, e il primo slalom della stagione si corre sulla pista frontale il 14 e 15 novembre 2026.',
        nl: '44 pistes dalen van de Levitunturi af naar het dorp aan de voet, en twee gondels brengen je naar de top op 531 meter. De alpine wereldbeker opent hier elke november, en de eerste slalom van het seizoen wordt op de frontpiste verreden op 14 en 15 november 2026.',
    ...
    },
    {
      ...
      body: {
        ...
        de: 'Rund 230 Kilometer gepflegte Loipen führen vom Dorf hinaus in die Fjells, davon 28 Kilometer in den dunklen Monaten beleuchtet. Wähl ein Loipencafé als Wendepunkt, lauf hinaus auf einen Kaffee und gleite vor der Dämmerung zurück.',
        ...
        it: 'Circa 230 chilometri di piste battute partono dal villaggio verso le montagne, di cui 28 chilometri illuminati nei mesi bui. Scegli un caffè lungo la pista come punto di ritorno, raggiungilo sugli sci per un caffè e torna scivolando prima del tramonto.',
  ...
  highlights: [
    {
      title: {
        ...
        it: 'Il centro sciistico più settentrionale d’Europa',
    ...
    },
    {
      ...
      body: {
        ...
        de: 'Kiilopää, betrieben vom Outdoor-Verband Suomen Latu, liegt direkt neben dem Urho-Kekkonen-Nationalpark. Markierte Routen beginnen an der Tür und reichen von einer Ein-Kilometer-Runde bis zu Touren von über zwanzig, die Länge des Tages wählst du also selbst.',
        ...
        it: 'Kiilopää, gestito dall’associazione outdoor Suomen Latu, si trova proprio accanto al Parco Nazionale Urho Kekkonen. I percorsi segnalati partono dalla porta e vanno da un anello di un chilometro a camminate di oltre venti, così la lunghezza della giornata la scegli tu.',
        nl: 'Kiilopää, gerund door de outdoorvereniging Suomen Latu, ligt pal naast Nationaal Park Urho Kekkonen. Gemarkeerde routes beginnen bij de deur en lopen van een lus van één kilometer tot tochten van ruim twintig, dus de lengte van de dag kies je zelf.',
    ...
    },
    {
      ...
      body: {
        ...
        nl: 'Bij Kuurakaltio stookt Kiilopää een traditionele rooksauna aan een fjeldbeek, en afkoelen doe je in stromend water in plaats van in een dompelbad. De openbare saunatijden staan ook open voor wie er niet logeert.',
