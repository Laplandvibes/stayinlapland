...
export const copyZHCN: SectionCopy = {
  ...
  hero: {
    ...
    h1Line1: '拉普兰不止是',
    h1Line2: '一周的假期。',
    lead: '按周入住的木屋、罗瓦涅米的精品酒店、那一晚梦寐以求的玻璃冰屋，以及最后一条公路尽头的荒野别墅。已验证价格区间',
  ...
  home: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: '玻璃冰屋是拉普兰的标志性形式，它有自己的页面。但人们最爱、回味最久的拉普兰之旅，并不是在玻璃穹顶下住三晚的打卡式旅行，而是以木屋或设计酒店为一周的大本营，再附加一两晚别处的住宿。这份网站映射的，是拉普兰真正回报回头客的方式。',
      },
      {
