...
export const copyES: SectionCopy = {
  ...
  destinationsData: [
    ...
    },
    {
      slug: 'levi',
      pitch:
        'La mayor estación de esquí de Finlandia, con la oferta más amplia de apartamentos a pie de pista y una calle de pueblo de verdad.',
      longStayAngle:
    ...
    {
      slug: 'inari',
      pitch: 'Capital cultural sami, lago Inari (1 084 km²), la base de larga estancia más septentrional de Finlandia.',
      longStayAngle:
